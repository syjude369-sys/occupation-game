...
function selectCandidate(id) {
  ...
  $("selectionLabel").textContent =
    `R ${candidate.params.rook.toFixed(1)} · B ${candidate.params.bishop.toFixed(1)} · N ${candidate.params.knight.toFixed(1)} · D ${Number(candidate.params.distanceMode ?? 0).toFixed(2)} · C ${Number(candidate.params.cohesion ?? 0).toFixed(1)} · Attack ${candidate.params.attack.toFixed(1)}%`;
  ...
  frontier.forEach((candidate, index) => {
    ...
    button.innerHTML = `
      ...
      <span class="resultBody">
        <span class="weights">R ${candidate.params.rook.toFixed(1)} · B ${candidate.params.bishop.toFixed(1)} · N ${candidate.params.knight.toFixed(1)} · D ${Number(candidate.params.distanceMode ?? 0).toFixed(2)} · C ${Number(candidate.params.cohesion ?? 0).toFixed(1)} · A ${candidate.params.attack.toFixed(1)}</span>
        <span class="scores">
